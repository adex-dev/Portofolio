...
export const Resume = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const menuData = await Experience();
          ...
          <div className=" border-slate-400 dark:border-white border-[1px] lg:h-[83vh] min-h-[83vh] overflow-auto lg:w-[80%] max-w-full  py-6">
            <div className="container">
              ...
              <p className="inline-flex gap-2 mx-auto w-full text-xs italic text-primary mb-4 capitalize text-primary lg:text-center text-justify justify-center font-dominemedium lg:px-8 px-2">
                Unleashing Creativity: Mastering Tools to Shape Stunning Digital
                Experiences.
              </p>
              <div className="grid gap-4 grid-cols-3 mx-4 lg:px-8 px-4 lg:grid-cols-4">
              ...
              <p className="uppercase text-lg text-primary  lg:text-2xl font-dominebold py-4 text-center underline">
                <span className="text-slate-400 dark:text-white">Ser</span>{" "}
                <span className="text-primary -mx-2">Vice</span>
              </p>
              <p className="inline-flex gap-2 mx-auto w-full text-xs italic text-primary mb-4 capitalize text-primary lg:text-center text-justify justify-center font-dominemedium lg:px-8 px-2">
                A Professional Front-End Developer, I Always Give The Best
                Effort For Each Projects I Did. I Give A Solution With My
                Creative App.
              </p>
              ...
              <p className="uppercase text-lg text-primary  lg:text-lg font-dominebold py-4 text-center underline">
                <span className="text-slate-400 dark:text-white">I'm Familiar</span>{" "}
