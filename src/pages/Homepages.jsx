      ...
      <div className="container mx-auto px-4 min-h-[90vh] lg:flex py-32 lg:py-12">
        <div className="grid gap-4 lg:grid-cols-2 grid-cols-1">
          <div className="flex flex-col leading-10 justify-center lg:-mt-6">
            ...
            <h2 className="font-bold uppercase text-3xl font-dominebold lg:text-5xl dark:text-white">
              I'M Akmad Nudin
            </h2>
            <h4 className="uppercase text-lg mb-6">
              <span className="font-medium font-dominemedium text-slate-500 text-base mb-5 lg:text-2xl">
                FullStack
              </span>{" "}
              | <span className="font-bold font-dominemedium dark:text-white">Web Developer</span>
            </h4>
            ...
            <div className="-mt-6 leading-7"><p className=" text-slate-400">+62812-2012883</p>
            <p className=" text-slate-400">akmadnudin.inc@gmail.com</p></div>
            <a href="/contact" className="btnbox w-36 font-dominebold">
              Hire Me
            </a>
          </div>
