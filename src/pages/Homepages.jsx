        ...
        <div className="grid gap-4 lg:grid-cols-2 grid-cols-1">
          ...
          <div className="flex flex-col leading-10 justify-center w-full lg:w-2/3 lg:mx-auto ">
            ...
            <div className="flex items-center justify-center w-full">
              <ul className="inline-flex space-x-3 mx-auto bg-slate-300 backdrop-blur-sm p-2 dark:bg-white rounded shadow-lg">
                <li>
                  <a href="https://id.linkedin.com/in/akmadnudin" target="_blank" rel="noreferrer">
                  <svg
                    role="img"
                ...
                <li>
                <a href="https://wa.me/send/?phone=+628122012883" target="_blank" rel="noreferrer">
                  <svg
                    role="img"
                    className="fill-current icon"
                    width="25"
                ...
                <li>
                <a href="https://instagram.com/akmadnudin.inc" target="_blank" rel="noreferrer">
                  <svg
                    className="fill-current icon"
                    width="25"
                    role="img"
                ...
                <li>
                <a href="https://github.com/adex-dev" target="_blank" rel="noreferrer">
                  <svg
                    role="img"
                    className="fill-current icon"
                    width={25}
                ...
                <li>
                <a href="https://youtube.com/@akmadnudininc" target="_blank" rel="noreferrer">
                  <svg
                    role="img"
                    className="fill-current icon"
                    width={25}
